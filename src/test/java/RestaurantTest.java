...
class RestaurantTest {
    ...
    public void is_restaurant_open_should_return_true_if_time_is_between_opening_and_closing_time(){
        Mockito.when(this.restaurant.getCurrentTime()).thenReturn(LocalTime.parse("11:00:00"));
        Assertions.assertTrue(this.restaurant.isRestaurantOpen());
    }

    @Test
    public void is_restaurant_open_should_return_false_if_time_is_outside_opening_and_closing_time(){
        Mockito.when(this.restaurant.getCurrentTime()).thenReturn(LocalTime.parse("09:00:00"));
